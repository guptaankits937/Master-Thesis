...
def predict_test_data( test_set, discovered_rules ):
    ...
    for row in test_set.data:
        ...
        for rule in discovered_rules:
            ...
            #
                ...
                break
    # print("rule consequent", rule.consequent.keys())
    # print("Length of test dataset",len(test_set.data))
    # print("Correct prediction test:", true_pos+true_neg+false_pos+false_neg)
    #print("",confusion_matrix[rule.consequent][row[test_set.attr_idxs[class_attr]]])

    # incorrect_predictions = len(test_set.data) - correct_predictions
    # correct_predictions = true_pos+true_neg
    # incorrect_predictions = (true_pos+true_neg+false_pos+false_neg)-correct_predictions
    # print("True positive:",true_pos)
    # print("True Negative:", true_neg)
    # print("False positive:", false_pos)
    # print("False Negative:", false_neg)
    # accuracy = (true_pos+true_neg) / (true_pos+true_neg+false_pos+false_neg)
    # predict_accuracy=correct_predictions/len(test_set.data)
    # print("Predict Accuracy = %f" % predict_accuracy)
    ...
    # results = confusion_matrix(rule.consequent,test_set.attr_idxs[class_attr])
    # print('Confusion Matrix :')
    # print(results)
    # print('Accuracy Score :', accuracy_score(test_set.data,class_attr))
    # print('Classification Report : ')
    # print(classification_report(test_set.data,class_attr))
    ...
    # # This is the ROC curve
    # fig, ax = plt.subplots()
    # ax.bar([0,1,2,3], [accuracy, F1_score,precision,recall], width=1, tick_label=['Accuracy', 'F Score'], align='center')
    # plt.show()
    #
    # # This is the AUC
    # auc = np.trapz(x,y)
    ...
    # fpr, tpr, thresholds = roc_curve(test_set, discovered_rules)
    # roc_auc = auc(fpr, tpr)
    #
    # plt.figure()
    ...
    # s = pd.Series([accuracy, F1_score, precision, recall], index=["Accuracy", "F1 Score", "Precision", "Recall"])
    #
    # # Set descriptions:
    # plt.title("Ant Miner Result")
    ...
    # # Plot the data:
    #
    # s.plot(kind='line',linestyle='-', color=list('rgbkymc'), )
    # plt.show()
